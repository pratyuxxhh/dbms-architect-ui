        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {STEPS.map((item, index) => {
            ...
            return (
              <div
                key={item.step}
                className="relative flex flex-col p-8 rounded-3xl bg-surface/60 border border-primary/15 shadow-lg shadow-primary/5 hover:border-primary/30 hover:bg-surface/80 transition-all duration-250 group"
              >
                {/* Step Number Badge */}
