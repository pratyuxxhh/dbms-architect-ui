...
export default function Testimonials() {
  return (
    <section className="py-12 sm:py-20 lg:py-24 bg-surface/40 border-y border-primary/10 relative">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {TESTIMONIALS.map((item, idx) => (
            <div
              key={idx}
              className="flex flex-col justify-between p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-background border border-primary/15 shadow-lg shadow-primary/5 relative hover:border-primary/30 transition-all hover:scale-[1.01]"
            >
              <div>
                {/* Quote Icon & Stars */}
